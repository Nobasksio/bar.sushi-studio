<template >
    <v-container fluid>
        <div class="page_area d-flex footer_padding" >
            <left-menu page="bonus"></left-menu >
            <div class="pl-5  pt-3" >
                <h1 class="bold" >
                    Бонусы
                </h1 >

                <!--<v-img src="/image/akc1.jpg"-->
                       <!--max-width="881"-->
                       <!--class="pt-5"-->
                       <!--:contain="true"-->
                <!--&gt;</v-img >-->
                <div class="py-4 bold body-1" >Как это работает</div >
                <div class="pb-4 body-2" >
                    <ul>
                        <li>
                            <span>Делаете заказ в любом суши-баре Sushi-Studio.
                            </span>
                        </li>
                        <li>
                            <span>Авторизуетесь в приложении Sberfood.
                            </span>
                        </li>
                        <li>
                            <span>Копите бонусные балы и олачивайте ими заказы. Получайте бонусные ранги и получайте повышенный процент бонусов
                            </span>
                        </li>
                    </ul>
                ...
                <div class="py-4 bold body-1" >Бонусные ранги</div >
                <div class="pb-4 body-2" >
                    <ul>
                        <li>
                            <span>Базовый ранг 5% Присваивается при любом заказе до 3 000 р.
                            </span>
                        </li>
                        <li>
                            <span>Серебряный ранг 10% Присваивается при заказе* от 3 000 р.
                            </span>
                        </li>
                        <li>
                            <span>Золотой ранг 15% Присваивается при заказе* от 6 000 р.
                            </span>
                        </li>
                    </ul>
                ...
                <div class="py-4 bold body-1" >Использование бонусной программы лояльности Sushi-Studio</div >
                <div class="pb-4 body-2" >
                    <ul>
                        <li>
                            <span>В соответствии с вашим рангом, с каждого заказа** на ваш личный бонусный счет Sushi-Studio будет зачисляться процент от суммы заказа.
                            </span>
                        </li>
                        <li>
                            <span>Узнать количество ваших бонусных рублей вы можете в мобильном приложении Plazius, либо в нижней части чека.
                            </span>
                        </li>
                        <li>
                            <span>Бонусными рублями вы можете оплатить до 100% стоимости вашего заказа в любом Суши-баре Sushi-Studio.
                            </span>
                        </li>
                        <li>
                            <span>Срок жизни бонусов — 90 дней с даты последнего заказа(по истечении этого срока бонусы обнуляются)
                            </span>
                        </li>
                        <li>
                            <span>Срок жизни бонусного ранга 1 год. По истечении этого срока бонусный ранг снижается до «базового»
                            </span>
                        </li>
                    </ul>

                </div >
                <h3 class="" >Скачать приложение </h3 >
               <v-row align="center">
                   <v-col cols="auto">
                       <a href="https://apps.apple.com/ru/app/sberfood-%D0%BA%D0%B0%D1%84%D0%B5-%D0%B8-%D1%80%D0%B5%D1%81%D1%82%D0%BE%D1%80%D0%B0%D0%BD%D1%8B/id794999619">
                   ...
                   <v-col cols="auto">
                       <a href="https://play.google.com/store/apps/details?id=ru.platius.mobile&shortlink=885b83b6&pid=B2C%20Landing&c=GP_up">
                       <img contain height="40" src="/image/gb.png"></img>
                       </a>
                   </v-col>
               </v-row>
            </div >
...
<script >
    ...
    export default {
        ...
        head () {
            return {
                title:'Бонусы в Суши-Барах Sushi-Studio Иркутск Японская кухня. Суши и роллы.',
                meta: [
                    { charset: 'utf-8' },
                    { name: 'viewport', content: 'width=device-width, initial-scale=1' },
                    { hid: 'description', name: 'description', content: ' Бонусы в уютные японские суши бары в Иркутске. Вкусная атмосфера классической и современной японии. Японская кухня, бизнес-ланч, Роллы, суши, сеты. ' }
                ]
            }
        },
    }
